...
type StripePayRequest struct {
	...
	// TopUpTarget selects the personal wallet or organization fund pool.
...
func (*StripeAdaptor) RequestAmount(c *gin.Context, req *StripePayRequest) {
	...
	if rejectInvalidCreditedQuota(c, id, target, getStripeCreditedQuota(req.Amount, group)) {
		return
	}
...
func (*StripeAdaptor) RequestPay(c *gin.Context, req *StripePayRequest) {
	...
	if rejectInvalidCreditedQuota(c, id, target,
