...
// UserCheckin executes the daily grant and wallet credit atomically on every
// supported database. The unique check-in row and ledger key make retries
// idempotent without a non-transactional SQLite special case.
func UserCheckin(userId int) (*Checkin, error) {
	...
	syncUserWalletCreditCache(userId, int64(quotaAwarded), creditResult, "checkin")
	return checkin, nil
}
