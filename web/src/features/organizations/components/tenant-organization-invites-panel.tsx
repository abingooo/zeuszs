...
import {
  disableTenantOrganizationInvite,
  listTenantOrganizationInvites,
...
export function TenantOrganizationInvitesPanel(props: {
  ...
  const invitesQuery = useQuery({
    queryKey: tenantOrganizationKeys.inviteList(queryParams),
    queryFn: () => listTenantOrganizationInvites(queryParams),
    placeholderData: keepPreviousData,
  })
  const disableMutation = useMutation({
    mutationFn: disableTenantOrganizationInvite,
    onSuccess: () => {
      void queryClient.invalidateQueries({
        queryKey: tenantOrganizationKeys.invites(),
      })
      void queryClient.invalidateQueries({
